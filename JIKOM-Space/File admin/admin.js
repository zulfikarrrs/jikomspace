// ===== AUTH =====
    ...
    const DEFAULT_KARYA = [
      { id: "k-1", kategori: ["trending", "angkatan"], judul: "Dokumenter: Kehidupan Nelayan Kupang", penulis: "Maria Fernanda", tanggal: "28 August 2025", deskripsi: "Sebuah dokumenter mendalam tentang kehidupan nelayan pesisir Kupang dalam menghadapi perubahan iklim dan tantangan ekonomi modern.", kontenLengkap: "<p>Kupang, 28 Agustus 2025 – Perubahan iklim bukan lagi sekadar isu global yang dibahas di konferensi tingkat tinggi. Di pesisir Kupang, dampaknya telah menjadi kenyataan sehari-hari bagi komunitas nelayan tradisional.</p><p>Melalui dokumenter ini, kami menelusuri kehidupan keluarga nelayan yang harus beradaptasi dengan cuaca ekstrem dan pola musim tangkapan ikan yang semakin tidak menentu.</p>", gambar: "https://lh3.googleusercontent.com/d/1L2e9ng8nymj3iZXU4QSndR0Y8Q_iabmS" },
      { id: "k-2", kategori: ["trending"], judul: "Poster Kampanye Literasi Digital", penulis: "Christina Lopo", tanggal: "15 August 2025", deskripsi: "Karya desain poster pemenang lomba kampanye literasi digital tingkat mahasiswa se-Provinsi NTT.", kontenLengkap: "<p>Desain poster kampanye literasi digital ini dibuat untuk mengikuti ajang kompetisi desain se-Nusa Tenggara Timur.</p>", gambar: "https://lh3.googleusercontent.com/d/1oyRhkVyQdFE9rdHeBvthA9V62rFY36QT" },
      { id: "k-3", kategori: ["trending"], judul: "Infografis: Statistik Medsos Gen-Z NTT", penulis: "Agustina Kale", tanggal: "10 July 2025", deskripsi: "Visualisasi data komprehensif mengenai pola konsumsi media sosial di kalangan mahasiswa dan remaja Nusa Tenggara Timur.", kontenLengkap: "<p>Menganalisis dan memahami pola konsumsi konten sangatlah penting bagi pemasar digital dan edukator.</p>", gambar: "https://lh3.googleusercontent.com/d/1O9D5zSdEx-j-E2w3rHbucMM1C9vso5Dr" },
      { id: "k-4", kategori: ["pilihan", "angkatan"], judul: "Opini: Transformasi Digital di NTT", penulis: "Yohanes Bere", tanggal: "02 June 2025", deskripsi: "Artikel opini yang mengkritisi sekaligus memberi solusi atas lambatnya pemerataan akses internet di daerah pelosok.", kontenLengkap: "<p>Kesenjangan digital masih menjadi PR besar di wilayah Indonesia Timur.</p>", gambar: "https://lh3.googleusercontent.com/d/1d-N_46fjGFRd9SKWcurBGKpV9_srbR4H" },
      { id: "k-5", kategori: ["pilihan"], judul: "Suara Mahasiswa JIKOM Episode 5", penulis: "Rafael Taneo", tanggal: "18 May 2025", deskripsi: "Bincang santai bersama dosen tamu mengenai peluang karir mahasiswa Ilmu Komunikasi di era AI dan otomasi.", kontenLengkap: "<p>Episode ke-5 dari podcast Suara Mahasiswa JIKOM mengangkat fenomena AI yang mendisrupsi dunia kerja.</p>", gambar: "https://lh3.googleusercontent.com/d/1lPfMwfx87phkV1nYL6GhtgothkQG4Dka" },
      { id: "k-6", kategori: ["pilihan", "angkatan"], judul: "Video Essay: Budaya Ikat Timor", penulis: "Dominikus Luan", tanggal: "21 April 2025", deskripsi: "Esai visual yang menceritakan makna filosofis di balik setiap motif tenun ikat dari berbagai daerah di pulau Timor.", kontenLengkap: "<p>Tenun ikat lebih dari sekadar helaian kain; ini adalah identitas dan buku harian dari sebuah peradaban kuno.</p>", gambar: "https://lh3.googleusercontent.com/d/1dNxiza-SN72Tj5QGSxEWvMFrrH9z-OB2" },
      { id: "k-7", kategori: ["pilihan", "angkatan"], judul: "adalah pokoknya", penulis: "fikar", tanggal: "26 April 2010", deskripsi: "Esai visual yang menceritakan makna filosofis di balik setiap motif tenun ikat dari berbagai daerah di pulau Timor.", kontenLengkap: "<p>Tenun ikat lebih dari sekadar helaian kain; ini adalah identitas dan buku harian dari sebuah peradaban kuno yang diwariskan dari generasi ke generasi.</p>", gambar: "https://lh3.googleusercontent.com/d/1D_SMH9QzLdIyzVuSDzXLejuaNUSNCWhd" }
    ];

    const DEFAULT_PUBLISH = [
      { id: "p-1", kategori: ["berita"], tanggal: "28 November 2025", penulis: "Mey Oktaviany & Titin Mastri", judul: "Praktik Jurnalisme Online di KupangNews", deskripsi: "Mahasiswa JIKOM Undana belajar produksi berita online, penulisan cepat, dan etika jurnalistik langsung di redaksi.", kontenLengkap: "<p>Kupang – Pada pertengahan November lalu, sekelompok mahasiswa JIKOM Undana berkesempatan melakukan praktik kerja lapangan langsung di ruang redaksi KupangNews.</p>", gambar: "https://lh3.googleusercontent.com/d/1TbA0H6i0Po6FfLAbsjDVikN9bcN3usZH" },
      { id: "p-2", kategori: ["opini"], tanggal: "12 April 2026", penulis: "Yohanes Bere", judul: "Mengapa Literasi Media Penting untuk Gen-Z?", deskripsi: "Kritik dan pandangan mahasiswa tentang pentingnya membaca berita dengan cermat dan bijak menanggapi disinformasi.", kontenLengkap: "<p>Generasi Z tumbuh di tengah era informasi yang melimpah ruah, sering kali informasi tersebut tidak melalui proses penyaringan jurnalistik yang ketat.</p>", gambar: "https://lh3.googleusercontent.com/d/1Y7FaR9GdttNEFkqyRc1Cp0K_Dg30q7Ez" },
      { id: "p-3", kategori: ["liputan"], tanggal: "10 April 2026", penulis: "Rafael Taneo", judul: "Potret Aksi Mahasiswa dalam Kampanye Literasi", deskripsi: "Liputan lengkap kegiatan literasi digital yang digelar oleh JIKOM di berbagai titik kumpul komunitas Kupang.", kontenLengkap: "<p>Aksi nyata ditunjukkan oleh komunitas mahasiswa JIKOM Undana pada hari Minggu kemarin di Taman Nostalgia, Kupang.</p>", gambar: "https://lh3.googleusercontent.com/d/1dzzuUsAkhBUty-7IyKwdf1O1dkF8BffN" },
      { id: "p-4", kategori: ["berita"], tanggal: "5 April 2026", penulis: "Agustina Kale", judul: "Mahasiswa JIKOM Raih Penghargaan Jurnalistik", deskripsi: "Cerita prestasi mahasiswa dalam lomba jurnalistik tingkat provinsi, mengangkat isu lingkungan pesisir.", kontenLengkap: "<p>Kabar gembira datang dari delegasi JIKOM Undana yang baru saja menjuarai kompetisi penulisan artikel jurnalistik tingkat provinsi.</p>", gambar: "https://lh3.googleusercontent.com/d/1-XeYzzgpZSD-AKY1nls7Gc3mqil2JTwm" },
      { id: "p-5", kategori: ["opini"], tanggal: "1 April 2026", penulis: "Dominikus Luan", judul: "AI dalam Jurnalistik: Ancaman atau Peluang?", deskripsi: "Refleksi mendalam mahasiswa mengenai peran kecerdasan buatan di meja redaksi media masa kini.", kontenLengkap: "<p>Sejak kemunculan model kecerdasan buatan generatif, industri media mulai bereksperimen dengan penulisan artikel otomatis.</p>", gambar: "https://lh3.googleusercontent.com/d/1uI27g-L-6bM08mC6G51lB0pEHKZ_GZzR" }
    ];

    function loadAll() {
      // data.js dari GitHub = sumber kebenaran utama (single source of truth)
      const sourceK = typeof daftarKarya !== 'undefined' ? daftarKarya : DEFAULT_KARYA;
      const sourceP = typeof daftarPublish !== 'undefined' ? daftarPublish : DEFAULT_PUBLISH;

      // Buat "sidik jari" dari data.js untuk mendeteksi apakah ada admin lain yang push
      const currentHash = JSON.stringify(sourceK.map(k => k.id).sort())
                        + '|' + JSON.stringify(sourceP.map(p => p.id).sort());
      const savedHash = localStorage.getItem('jikom_data_hash');

      let oldSourceKIds = new Set();
      let oldSourcePIds = new Set();
      if (savedHash) {
        try {
          const parts = savedHash.split('|');
          if (parts.length === 2) {
            oldSourceKIds = new Set(JSON.parse(parts[0]));
            oldSourcePIds = new Set(JSON.parse(parts[1]));
          }
        } catch(e) {}
      }

      if (savedHash === currentHash) {
        // data.js BELUM berubah sejak terakhir kali → pakai localStorage
        // (mungkin admin ini punya draft baru yang belum di-generate & push)
        const sk = localStorage.getItem('jikom_karya');
        const sp = localStorage.getItem('jikom_publish');
        karyaData = sk ? JSON.parse(sk) : JSON.parse(JSON.stringify(sourceK));
        publishData = sp ? JSON.parse(sp) : JSON.parse(JSON.stringify(sourceP));
      } else {
        // data.js BERUBAH (ada admin lain yang push update) → muat data.js terbaru
        karyaData = JSON.parse(JSON.stringify(sourceK));
        publishData = JSON.parse(JSON.stringify(sourceP));

        // Tetapi jangan buang draft lokal yang belum sempat di-push
        const localK = JSON.parse(localStorage.getItem('jikom_karya') || '[]');
        const localP = JSON.parse(localStorage.getItem('jikom_publish') || '[]');
        const sourceKIds = new Set(sourceK.map(k => k.id));
        const sourcePIds = new Set(sourceP.map(p => p.id));

        // Tambahkan item BARU lokal yang belum ada di data.js
        localK.forEach(item => {
          if (!sourceKIds.has(item.id) && !oldSourceKIds.has(item.id)) {
            karyaData.unshift(item);
          }
        });
        localP.forEach(item => {
          if (!sourcePIds.has(item.id) && !oldSourcePIds.has(item.id)) {
            publishData.unshift(item);
          }
        });

        // Simpan hash baru & state gabungan
        localStorage.setItem('jikom_data_hash', currentHash);
  ...
  `).join('');
    ...
    // Close modals on overlay click — pasang di dalam DOMContentLoaded agar aman
    document.addEventListener('DOMContentLoaded', () => {
      const mo = document.getElementById('modalOverlay');
      const ip = document.getElementById('imgPickerOverlay');
      if (mo) mo.addEventListener('click', e => { if (e.target === e.currentTarget) closeModal(); });
      if (ip) ip.addEventListener('click', e => { if (e.target === e.currentTarget) closeImgPicker(); });
    });

    // Init lucide — aman meski CDN lambat
    function initLucide() {
      if (window.lucide) window.lucide.createIcons();
    }
