...
document.getElementById("menuBtn").addEventListener("click", () => {
    ...
    function renderSidebarKarya() {
      ...
      daftarKarya.slice(0, 4).forEach(karya => {
        recentHtml += `
        <a href="detail.html?type=karya&id=${karya.id}" class="flex gap-4 group items-start mb-2">
      ...
      paginatedItems.forEach(karya => {
        ...
        <article class="article-item block" data-categories="${dataCategories}">
          <div class="relative rounded-xl overflow-hidden mb-5 group">
            <a href="detail.html?type=karya&id=${karya.id}" class="block w-full">
          ...
          <a href="detail.html?type=karya&id=${karya.id}" class="block">
          ...
          <a href="detail.html?type=karya&id=${karya.id}" class="text-primary font-medium text-[14px] hover:text-orange-600 transition-colors inline-flex items-center gap-1.5">
            Read More &rarr;
          </a>
        </article>
        `;
